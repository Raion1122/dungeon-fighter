...
(function (global) {
   ...
   *  (NODES のキーに "__" も "@" も無い)。
   *  ⚠ 2026-09-02 実測 (#42 / cap=160): 14 本のうち **8 本**が分割され、刻み点は 10 個。
   *    (cap=320 のころは lake_n-lakeside 409.8px の 1 本だけだった) */
   ...
   *  ⚠ 2026-09-02 の実測 (#42 / cap=160) では **10 件** / 停留所 (NODES ∪ STEPS) は 24 箇所:
   *    forest__farm_n@1   (512.0, 288.0)     swamp__village_s@1 ( 640.0, 768.0)
   *    farm_n__pass_n@1   (672.0, 160.0)     village_s__fort@1  ( 832.0, 800.0)
   *    lake_n__lakeside@1 (842.7, 373.3)     fort__lakeside@1   ( 992.0, 640.0)
   *    lake_n__lakeside@2 (949.3, 458.7)     lakeside__mine@1   (1056.0, 448.0)
   *    cross_n__swamp@1   (512.0, 576.0)     lakeside__dragon@1 (1184.0, 608.0)
   *  ⚠⚠ うち cross_n__swamp@1 (沼地の札) と fort__lakeside@1 (廃墟の砦の札) の 2 個は
   *    羊皮紙の札の矩形へ食い込む (中心は 2.0px だけ逃げている)。⭐ 札のクリック点を
   *    奪っていないことと逃げ幅は verify_world_steps.js の (2d) が毎回測る。 */
  var STEPS = (function () {
    var m = {};
    for (var i = 0; i < EDGES.length; i++) {
